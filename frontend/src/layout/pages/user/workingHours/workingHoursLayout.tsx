...
import { WorkingHoursForm } from 'layout/pages/user/workingHours/workingHoursForm';
import { WorkingHoursRightColumn } from 'layout/pages/user/workingHours/workingHoursRightColumn';
