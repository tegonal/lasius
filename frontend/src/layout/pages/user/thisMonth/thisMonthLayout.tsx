...
import { CalendarMonth } from 'components/calendar/calenderMonth';
import { ThisMonthStats } from 'layout/pages/user/thisMonth/thisMonthStats';
...
export const ThisMonthLayout: React.FC = () => {
  return (
    <>
      <ScrollContainer sx={{ ...layoutColumnStyle, pt: 4 }}>
        <CalendarMonth />
      </ScrollContainer>
      <ScrollContainer
        sx={{
