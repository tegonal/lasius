...
object TimeBookingHistoryViewService {

  def props: Props = Props(new TimeBookingHistoryViewService)
}

class TimeBookingHistoryViewService extends UserService[StartUserTimeBookingView] {
  ...
  def aggregateProps(id: UserId) = UserTimeBookingHistoryView.props(id)
}