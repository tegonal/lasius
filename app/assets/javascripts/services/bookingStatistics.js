...
define(['angular'], function (angular) {
  ...
  mod.factory('bookingStatisticsService', ['$http', '$location', '$q', 'playRoutes', '$log', function ($http, $location, $q, playRoutes, $log) {
    ...
    return {             
      getAggregatedStatisticsByTagAndRange: function (userId, from, to) {
        return playRoutes.controllers.TimeBookingStatisticsController.getAggregatedStatisticsByTagAndRange(userId, from, to).get().then(function (response) {
